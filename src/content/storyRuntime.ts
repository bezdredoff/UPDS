...
import episodes1921Screenplay from './ANM-027G_Episodes_19_21_Screenplay.md?raw';
...
import episodes1921ManifestJson from './story/ANM027G.episodes-19-21.story.json';
...
export const canonicalStoryManifests = [
  ...
  episodes1921ManifestJson as StoryContentManifest,
] as const;

const sources = [verticalSliceScreenplay, episodes0406Screenplay, episodes0709Screenplay, episodes1012Screenplay, episodes1315Screenplay, episodes1618Screenplay, episodes1921Screenplay] as const;
