...
const ru = {
  ...
  'match3.help.specials.intro': 'Бонус заменяет обычную картинку фишки. Маленький значок в углу показывает её сохранённый тип.',
...
const be = {
  ...
  'match3.help.specials.intro': 'Бонус замяняе звычайную выяву фішкі. Маленькі значок у куце паказвае яе захаваны тып.',
...
const en = {
  ...
  'match3.help.specials.intro': 'A bonus replaces the normal tile artwork. The small corner marker shows its retained type.',
