...
describe('Belarusian Match-3 localization', () => {
  ...
  it('keeps the complete 620-key Match-3 production surface structurally aligned', () => {
    ...
    assertComplete(sourceMain, targetMain, 488, 'main Match-3 catalog');
    assertComplete(match3ReactionCatalogs.ru, match3ReactionCatalogs.be, 132, 'reaction catalog');
    assertComplete(source, target, 620, 'full Match-3 surface');
  });
