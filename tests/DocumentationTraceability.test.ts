...
describe('active documentation traceability', () => {
  ...
  it('keeps durable production foundations and localization feature documents traceable', () => {
    ...
    expect(roadmap).toContain('B3C R1 canonical runtime VN slot 2');
    ...
    expect(roadmap).toContain('B3H R1 canonical runtime VN slot 7');
    expect(roadmap).toContain('B3I R1 canonical runtime VN slot 8');
    expect(roadmap).toContain('B3J R1 canonical runtime VN slot 9');
    expect(roadmap).toContain('B3K R1.1 canonical runtime VN slot 10');
    expect(roadmap).toContain('B3L R1 canonical runtime VN slot 11');
    expect(roadmap).toContain('B3M R1 canonical runtime VN slot 12');
    expect(roadmap).toContain('B3N R1 canonical runtime VN slot 13');
    expect(roadmap).toContain('B3O R1 canonical runtime VN slot 14');
    expect(roadmap).toContain('B3P R1 canonical runtime VN slot 15');
