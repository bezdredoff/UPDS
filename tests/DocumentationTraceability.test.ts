...
describe('active documentation traceability', () => {
  ...
  it('keeps durable production foundations and historical character provenance traceable', () => {
    ...
    expect(campusServiceYardBackground).toContain('BG_CAMPUS_SERVICE_YARD.webp');
    expect(campusServiceYardBackground).toContain('1080×1920');
    expect(currentAssetAudit).toContain('"productionBackgroundVariants": 9');
    expect(currentAssetAudit).toContain('"runtimeFallbackBackgroundVariants": 15');
