...
- [`features/ANM028B1_REUSABLE_STAGING_PRESETS_RU.md`](features/ANM028B1_REUSABLE_STAGING_PRESETS_RU.md) — R4 candidate: eight reusable presets using the playable VN frame, focal-eye-line trio staging, ANM-024 viewport/background calibration, visual-approval-aware lineup, diagnostics and zero-new-art budget preview
...
eye-line-anchored shot derivation. Technical integration and visual approval are separate; Emi is
