...
- [`features/ANM030B1B1_STUDENT_COUNCIL_AUDITORIUM_RU.md`](features/ANM030B1B1_STUDENT_COUNCIL_AUDITORIUM_RU.md) — first approved early-route background semantic closure: dedicated student-council auditorium art for Story slot 4, runtime mapping and current audit status
- [`features/ANM030B1B2_ASTERION_SMART_TEXTILE_LAB_RU.md`](features/ANM030B1B2_ASTERION_SMART_TEXTILE_LAB_RU.md) — approved golden master for the Asterion background family: dedicated smart-textile laboratory art for Story slot 7, runtime mapping and current audit status
- [`features/ANM030B1B3_LOST_FOUND_WAREHOUSE_RU.md`](features/ANM030B1B3_LOST_FOUND_WAREHOUSE_RU.md) — approved golden master for the laundry-service background family: dedicated lost-found warehouse art for Story slot 8, runtime mapping and current audit status
- [`features/ANM030B1B4_CAMPUS_SERVICE_YARD_RU.md`](features/ANM030B1B4_CAMPUS_SERVICE_YARD_RU.md) — approved golden master for the campus-exterior background family: dedicated university service-yard art for Story slot 11, runtime mapping and current audit status
- [`features/ANM030B1B5_ABANDONED_LAUNDRY_RU.md`](features/ANM030B1B5_ABANDONED_LAUNDRY_RU.md) — approved golden master for the old-building-finale background family: dedicated abandoned-laundry art for Story slot 15 and completion of master-family coverage
- [`features/ANM030B1B6_HIGH_USAGE_BACKGROUND_TRIO_RU.md`](features/ANM030B1B6_HIGH_USAGE_BACKGROUND_TRIO_RU.md) — usage-prioritized production batch for textile-workshop, combat-club-hall and old-archive across eleven common-route scene appearances
- [`features/ANM030B0A1_MATCH3_SPECIAL_VISUAL_CONTRACT_RU.md`](features/ANM030B0A1_MATCH3_SPECIAL_VISUAL_CONTRACT_RU.md) — original production contract for the shared five-asset Match-3 special/bonus pack, now adopted by B0A2
- [`features/ANM030B0A2_MATCH3_SPECIAL_ASSET_INTEGRATION_RU.md`](features/ANM030B0A2_MATCH3_SPECIAL_ASSET_INTEGRATION_RU.md) — completed five-PNG production pack, semantic SVG fallback, offline/preload registration and localized in-game Help guide
...
`src/ui/vnPortraitGeometry.ts` owns runtime-top and multi-actor eye-line camera derivation. ANM-030B0B–B0F leave all nine current full-stage characters canonical and approved, with all 63 runtime assets digest-locked and a Mobile WebKit full-cast lineup gate. `src/content/art/ANM030A.asset-gap-audit.json` (`upds-asset-gap-audit-v1`) reports the cast at 9/9 production-ready while preserving current guest/background/clue gaps. The five existing Match-3 special mechanics now use one shared production PNG pack across all 22 levels; semantic SVG fallback, preload/offline delivery and the RU/BE/EN Help guide are locked by `src/content/art/ANM030B0A1.match3-special-visual-contract.json` (`upds-match3-special-visual-contract-v1`).
...
- [`features/ANM030B1B9_IOS_SAFE_AREA_REPAIR_RU.md`](features/ANM030B1B9_IOS_SAFE_AREA_REPAIR_RU.md) — R7 installed-iPhone physical full-bleed contract, large-iPhone `440px` coverage and non-negative sticky panel headers
