...
KI-001/KI-003 не закрывались этим refactor; их позднее закрыло отдельное online/offline QA
установленной PWA G0-PWA-001 на реальном iPhone 2026-09-11. Если физическая полоса появляется
снова, она не должна быть замаскирована цветом текущего screen — это и есть желаемая
