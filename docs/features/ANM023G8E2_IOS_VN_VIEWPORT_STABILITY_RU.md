...
`vn-navigation.pw.ts` уже входит в `webkit-mobile` critical testMatch, поэтому regression автоматически работает и в Chromium full E2E, и в Mobile WebKit Browser Gate.
