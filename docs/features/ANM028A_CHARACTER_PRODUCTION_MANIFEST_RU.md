...
художественное одобрение. R4 добавил отдельный `visualApproval`: Miku/Onoe/Ayuki — `approved`,
...
Существующий Emi alpha-height считается технической метрикой временного fallback, а не
