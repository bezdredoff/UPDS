...
Status: active workflow aligned with ANM-027E and the ANM-028B1 R2 candidate.
...
- After 028B1 R2 visual acceptance, build scenes only from the frozen `upds-scene-staging-v1` IDs in `src/data/sceneStaging.ts`:
