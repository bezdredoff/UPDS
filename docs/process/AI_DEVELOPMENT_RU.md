...
Authored repository sources are incremental: ANM-003 owns slots `0–3`, and `src/content/ANM-027G_Episodes_04_06_Screenplay.md` owns slots `4–6`. Do not invent slots `7–21` inside a technical feature or claim they exist because an old handoff mentions a plan.
...
- Add detailed content in reviewable packages of three sequential episodes before mass localization/art production; `4–6` is the first implemented package and `7–9` is the next package after its acceptance.
