...
- Add detailed content in reviewable packages of three sequential episodes before mass localization/art production; `4–6`, `7–9`, `10–12` and `13–15` are implemented packages; `16–18` is the next package after acceptance.
