...
Status: active architecture through completed ANM-027G `0–21` canonical story, merged ANM-029A/B1/B2A/B2B1/B2B2 localization foundations; ANM-029B2B3 Belarusian Match-3 levels `14–21` are in QA.
